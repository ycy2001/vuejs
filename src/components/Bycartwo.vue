      ...
      <div class="content mar_20">
        <div class="two_bg">
          ...
          <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
            ...
            <tr v-for="index in goods">
              <td>
                <div class="c_s_img"><img src="../../static/images/c_1.jpg" width="73" height="73" /></div>
                {{index.goods_name}}
              </td>
              <td align="center">{{index.key}}</td>
              <td align="center">{{index.goods_num}}</td>
              <td align="center" style="color:#ff4e00;">{{index.zonjia}}</td>
              <td align="center">26R</td>
            </tr>
            <tr>
              <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                商品总价：￥35994.00 ； 返还积分 56R
              </td>
            </tr>
          </table>
          ...
          <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td v-for="index in getaddress">{{index.address}}</td>
...
<!--            <li>货到付款<div class="ch_img"></div></li>-->
          ...
          <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
            ...
            <tr height="70">
              <td align="right"><a href="#" @click="confirm"><img src="../../static/images/btn_sure.gif" /></a></td>
            </tr>
          </table>
...
export default {
  ...
  data () {
    return {
      bycar:localStorage.getItem('bycar'),
  ...
  methods:{
    confirm () {
      axios.post('http://localhost/ci/blog/public/api/confirm',{
        token: this.token,
        bycar: this.bycar
      })
        .then(response =>{
          if (response.data.status=='ok'){
            alert('订单添加成功');
            // location.href="http://localhost/ci/blog/public/api/index";
            location.href="http://localhost/ci/blog/public/api/index?token="+this.token+"&order_id="+response.data.order_id+"&price="+response.data.price+"";
          }
        })
    }
  },
  mounted:function () {
    axios.post('http://localhost/ci/blog/public/api/order',{
      token: this.token,
      bycar: this.bycar
    })
      .then(res => {
    ...
    axios.post('http://localhost/ci/blog/public/api/getaddress',{
      token: this.token,
    })
      .then(res => {
