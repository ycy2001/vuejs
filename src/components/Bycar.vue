    ...
    <div class="i_bg">
      ...
      <div class="content mar_20">
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          <tr>
            <td class="car_th" width="40">多选</td>
          ...
          <tr v-for=" index in goodscartshow">
            <td>
              <input type="checkbox" name="goods" v-bind:value="index.gid"">
            </td>
            <td>
              <div class="c_s_img"><img src="../../static/images/c_1.jpg" width="73" height="73" /></div>
              {{index.goods_name}}
            </td>
            <td align="center">{{index.key}}</td>
            <td align="center">
              <div class="c_num">
                <input type="button" value="" @click="jianUpdate(index.sid,index.goods_num);" class="car_btn_1" />
                <input type="text" v-bind:value="index.goods_num" name="" class="car_ipt" />
                <input type="button" value="" @click="addUpdate(index.sid,index.goods_num);" class="car_btn_2" />
              </div>
            </td>
            <td align="center" style="color:#ff4e00;">￥{{index.price}}</td>
          ...
          <tr valign="top" height="150">
            <td colspan="6" align="right">
              <a href="#"><img src="../../static/images/buy1.gif" /></a>&nbsp; &nbsp; <a @click="jiesuan" href="#"><img  src="../../static/images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
...
export default {
  ...
  mounted () {
    axios.post('http://localhost/ci/blog/public/api/goodscartshow',{
      token:localStorage.getItem('token')
    })
      .then(response => {
        this.goodscartshow = response.data.data
      })
  ...
  methods:{
    addUpdate:function (id,num) {
      axios.post('http://localhost/ci/blog/public/api/addUpdate',{
        id:id,
        num:num,
        token:localStorage.getItem('token')
      })
    },
    jianUpdate:function (id,num) {
      axios.post('http://localhost/ci/blog/public/api/jianUpdate',{
        id:id,
        num:num,
        token:localStorage.getItem('token'),
        jiesuan: []
    ...
    jiesuan:function () {
      var city=$("input[name='goods']:checked")
      var nerder=''
      for (var i = 0; i<city.length; i++){
        nerder=nerder+","+city[i].value
      }
      localStorage.setItem("bycar", nerder)
      location.href="http://localhost:8080/#/bycartwo"
    }
  }
}
</script>
