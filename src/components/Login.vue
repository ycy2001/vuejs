    ...
    <div class="log_c">
      <form>
        <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
          ...
          <tr height="70">
            <td>用户名</td>
            <td><input type="text" v-model="name" value="" class="l_user" /></td>
          </tr>
          <tr height="70">
            <td>密&nbsp; &nbsp; 码</td>
          ...
          <tr height="60">
            <td>&nbsp;</td>
            <td><input  @click="onlogin"  type="submit" value="登录" class="log_btn" /></td>
          </tr>
        </table>
      </form>
    </div>
...
export default {
  ...
  methods:{
    onlogin:function(event){
      ...
      axios.post('http://localhost/ci/blog/public/api/login',{
        name: this.name,
