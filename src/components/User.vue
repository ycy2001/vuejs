        ...
        <div class="m_left">
          ...
          <div class="left_m">
            ...
            <ul>
              ...
              <li><a href="http://localhost:8080/#/address">收货地址</a></li>
              <li><a href="#">缺货登记</a></li>
              <li><a href="#">跟踪订单</a></li>
            </ul>
          </div>
            ...
            <table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
              <tr valign="top">
                ...
                <td>
                  ...
                  <div class="m_notice">
                    <input  @click="loginout"  type="submit" value="退出" class="log_btn" />
                  </div>
                </td>
              </tr>
            </table>
...
export default {
  ...
  methods:{
    loginout:function(event) {
      ...
      axios.post('http://localhost/ci/blog/public/api/logout',{
        token: this.token,
      })
    }
  },
